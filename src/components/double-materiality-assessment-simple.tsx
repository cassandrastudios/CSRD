...
export function DoubleMaterialityAssessmentSimple() {
    ...
    try {
      ...
      const sampleTopics = [
        ...
        },
        {
          ...
          description:
            'Greenhouse gas emissions reduction and energy transition',
          category: 'Environmental',
          parent_id: 1,
          created_at: new Date().toISOString(),
        },
        {
          ...
          description: 'Adaptation measures and climate risk management',
          category: 'Environmental',
          parent_id: 1,
          created_at: new Date().toISOString(),
        },
        {
          ...
          description:
            'Energy consumption patterns and renewable energy transition',
          category: 'Environmental',
          parent_id: 1,
          created_at: new Date().toISOString(),
        },
        ...
        },
        {
          ...
          code: 'E2-1',
          name: 'Air Pollution',
          description: 'Air emissions and air quality management',
          category: 'Environmental',
          parent_id: 2,
          created_at: new Date().toISOString(),
        },
        {
          ...
          description: 'Water discharge and water quality management',
          category: 'Environmental',
          parent_id: 2,
          created_at: new Date().toISOString(),
        },
        {
          ...
          code: 'E2-3',
          name: 'Soil Pollution',
          description: 'Soil contamination and remediation',
          category: 'Environmental',
          parent_id: 2,
          created_at: new Date().toISOString(),
        },

        {
          ...
          description: 'Water and marine resource management',
          category: 'Environmental',
          parent_id: null,
          created_at: new Date().toISOString(),
        },
        {
          ...
          description: 'Water use efficiency and water stress management',
          category: 'Environmental',
          parent_id: 3,
          created_at: new Date().toISOString(),
        },
        {
          ...
          description: 'Marine ecosystem protection and sustainable fishing',
          category: 'Environmental',
          parent_id: 3,
          created_at: new Date().toISOString(),
        },
        ...
        },
        {
          ...
          description:
            'Land-based ecosystem protection and habitat conservation',
          category: 'Environmental',
          parent_id: 4,
          created_at: new Date().toISOString(),
        },
        {
          ...
          description: 'Endangered species protection and wildlife management',
          category: 'Environmental',
          parent_id: 4,
          created_at: new Date().toISOString(),
        },
        ...
        },
        {
          ...
          description: 'Material efficiency and resource optimization',
          category: 'Environmental',
          parent_id: 5,
          created_at: new Date().toISOString(),
        },
        ...
        // Social Topics with Subtopics
        {
          ...
          code: 'S1',
          name: 'Own Workforce',
          description: 'Rights and working conditions of workforce',
          category: 'Social',
          parent_id: null,
          created_at: new Date().toISOString(),
        },
        {
          ...
          description:
            'Health and safety, working hours, and workplace conditions',
          category: 'Social',
          parent_id: 6,
          created_at: new Date().toISOString(),
        },
        {
          id: 602,
          code: 'S1-2',
          name: 'Equal Treatment and Opportunities',
          description: 'Diversity, inclusion, and equal opportunities',
          category: 'Social',
          parent_id: 6,
          created_at: new Date().toISOString(),
        },
        {
          ...
          description: 'Employee representation and collective bargaining',
          category: 'Social',
          parent_id: 6,
          created_at: new Date().toISOString(),
        },

        {
          ...
          description: 'Rights of workers in the value chain',
          category: 'Social',
          parent_id: null,
          created_at: new Date().toISOString(),
        },
        {
          ...
          description: 'Labor rights and working conditions in supply chains',
          category: 'Social',
          parent_id: 7,
          created_at: new Date().toISOString(),
        },
        {
          id: 702,
          code: 'S2-2',
          name: 'Child Labor and Forced Labor',
          description: 'Prevention of child labor and forced labor',
          category: 'Social',
          parent_id: 7,
          created_at: new Date().toISOString(),
        },

        {
          ...
          description: 'Rights of affected communities',
          category: 'Social',
          parent_id: null,
          created_at: new Date().toISOString(),
        },
        {
          ...
          description: 'Local community development and impact management',
          category: 'Social',
          parent_id: 8,
          created_at: new Date().toISOString(),
        },
        {
          ...
          description: 'Indigenous peoples rights and cultural heritage',
          category: 'Social',
          parent_id: 8,
          created_at: new Date().toISOString(),
        },

        {
          ...
          description: 'Consumer and end-user rights',
          category: 'Social',
          parent_id: null,
          created_at: new Date().toISOString(),
        },
        {
          ...
          code: 'S4-1',
          name: 'Product Safety',
          description: 'Product safety and quality standards',
          category: 'Social',
          parent_id: 9,
          created_at: new Date().toISOString(),
        },
        {
          ...
          code: 'S4-2',
          name: 'Data Privacy',
          description: 'Consumer data protection and privacy rights',
          category: 'Social',
          parent_id: 9,
          created_at: new Date().toISOString(),
        },
        ...
        // Governance Topics with Subtopics
        {
          ...
          description: 'Business ethics and conduct',
          category: 'Governance',
          parent_id: null,
          created_at: new Date().toISOString(),
        },
        {
          ...
          description: 'Anti-corruption and anti-bribery measures',
          category: 'Governance',
          parent_id: 10,
          created_at: new Date().toISOString(),
        },
        {
          ...
          code: 'G1-2',
          name: 'Tax Strategy',
          description: 'Tax transparency and responsible tax practices',
          category: 'Governance',
          parent_id: 10,
          created_at: new Date().toISOString(),
        },

        {
          ...
          description: 'Corporate culture and values',
          category: 'Governance',
          parent_id: null,
          created_at: new Date().toISOString(),
        },
        {
          ...
          description: 'Board composition and leadership effectiveness',
          category: 'Governance',
          parent_id: 11,
          created_at: new Date().toISOString(),
        },
        {
          ...
          description: 'Values, ethics, and organizational behavior',
          category: 'Governance',
          parent_id: 11,
          created_at: new Date().toISOString(),
        },

        {
          id: 12,
          code: 'G3',
          name: 'Management of Material Sustainability Risks',
        ...
        },
        {
          ...
          description: 'Sustainability risk identification and management',
          category: 'Governance',
          parent_id: 12,
          created_at: new Date().toISOString(),
        },
        {
          ...
          code: 'G3-2',
          name: 'Due Diligence',
          description: 'Due diligence processes and procedures',
          category: 'Governance',
          parent_id: 12,
          created_at: new Date().toISOString(),
        },
  ...
  const updateScore = useCallback(
    (topicId: number, impactScore: number, financialScore: number) => {
      if (debouncedUpdate.current) {
        clearTimeout(debouncedUpdate.current);
      }
  ...
  const filteredTopics = topics
    .filter(topic => {
      ...
      const matchesSelected =
        !showOnlySelected || selectedTopics.includes(topic.id);
      ...
      switch (sortBy) {
        ...
        case 'score':
          const scoreA = getScore(a.id)
            ? (getScore(a.id)!.impact_materiality +
                getScore(a.id)!.financial_materiality) /
              2
            : 0;
          const scoreB = getScore(b.id)
            ? (getScore(b.id)!.impact_materiality +
                getScore(b.id)!.financial_materiality) /
              2
            : 0;
  ...
  const actualScores = scores.filter(score =>
    selectedTopics.includes(score.esrs_topic_id)
  );
  const progress =
    selectedTopics.length > 0
      ? (actualScores.length / selectedTopics.length) * 100
      : 0;
  ...
  const matrixData = scores.map(score => {
    ...
    return {
      ...
      materiality:
        (score.impact_materiality + score.financial_materiality) / 2 >= 3
          ? 'Material'
          : 'Non-Material',
    };
  });
        ...
        <Card>
          <CardHeader>
              ...
              <div className="flex items-center gap-2">
                ...
                <Button
                  ...
                  onClick={async () => {
                    if (
                      confirm(
                        'This will clear all your assessment data. Are you sure?'
                      )
                    ) {
                      try {
            ...
            <CardDescription>
              ...
              Each ESRS topic requires individual assessment for both Impact and
              Financial materiality as required by CSRD.
            </CardDescription>
          </CardHeader>
          <CardContent>
                ...
                <div className="text-3xl font-bold text-orange-600">
                  {
                    actualScores.filter(
                      s =>
                        (s.impact_materiality + s.financial_materiality) / 2 >=
                        3
                    ).length
                  }
                </div>
                      ...
                      {loading ? (
                        ...
                        <div className="p-8 text-center">
                          ...
                          <div className="mt-4 text-xs text-gray-400">
                            Debug: Topics: {topics.length}, Filtered:{' '}
                              ...
                              <div className="flex items-center justify-between">
                                <div className="flex-1">
                                  <div className="flex items-center gap-2">
                                    ...
                                    />
                                    <div
                                      className={`${isSubTopic ? 'ml-6' : ''}`}
                                    >
                                      <div
                                        className={`font-medium ${isSubTopic ? 'text-sm' : ''}`}
                                      >
                                        {topic.name}
                                      </div>
                                  ...
                                  <div
                                    className={`text-sm text-gray-600 mt-1 ${isSubTopic ? 'ml-6' : ''}`}
                                  >
                                    {topic.description}
                                  </div>
                                </div>
                                <div className="flex items-center gap-2">
                                  ...
                                  {getScore(topic.id) && (
                                    ...
                                    >
                                      {(getScore(topic.id)!.impact_materiality +
                                        getScore(topic.id)!
                                          .financial_materiality) /
                                        2 >=
                                      3
                  ...
                  <Card>
                    <CardContent className="flex items-center justify-center h-64">
                      <div className="text-center">
                        ...
                        <p className="text-gray-500">
                          Choose a topic to view details and begin assessment
                        </p>
                      </div>
                    </CardContent>
                  </Card>
                        ...
                        <div>
                          ...
                          <div className="space-y-2">
                            <label className="text-sm">
                              Impact Level: {score?.impact_materiality || 1}
                            </label>
                            <input
                              type="range"
                              min="1"
                        ...
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <div className="text-2xl font-bold">
                              {score
                                ? (
                                    (score.impact_materiality +
                                      score.financial_materiality) /
                                    2
                                  ).toFixed(1)
                                : '1.0'}
                            </div>
                      ...
                      <span className="font-medium">
                        {
                          scores.filter(
                            s =>
                              (s.impact_materiality + s.financial_materiality) /
                                2 >=
                              3
                          ).length
                        }
