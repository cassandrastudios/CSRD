...
export function ValueChainSidebar() {
  ...
  return (
    <div className="w-80 bg-white border-r border-gray-200 flex flex-col">
      ...
      {/* Stats */}
      <div className="p-6 border-b border-gray-200">
        <h3 className="text-sm font-medium text-gray-900 mb-3">Value Chain Overview</h3>
        <div className="grid grid-cols-2 gap-4">
          <div className="text-center">
            <div className="text-2xl font-bold text-blue-600">{valueChain.players.length}</div>
            <div className="text-xs text-gray-500">Players</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-green-600">{valueChain.relationships.length}</div>
