...
import {
  ESRS_Topic,
  MaterialityAssessment as MaterialityAssessmentType,
} from '@/types';
import {
  ScatterChart,
  Scatter,
...
export function MaterialityAssessment() {
  ...
  const updateAssessment = useCallback(
    (topicId: string, impact: number, financial: number) => {
    ...
    <Layout>
      <div className="space-y-6">
        ...
        <div className="flex justify-between">
          ...
          <Button>Continue to Data Hub</Button>
        </div>
      </div>
    </Layout>
  );
