    ...
    Tables: {
      ...
      stakeholders: {
        Row: {
          ...
          organization_id: string
          name: string
          category: 'employee' | 'client' | 'supplier' | 'civil_society' | 'investor' | 'regulator'
          contact_email: string | null
          influence_rating: number
          engagement_frequency: 'monthly' | 'quarterly' | 'annually' | 'as_needed'
          created_at: string
          updated_at: string
        }
        Insert: {
      ...
      stakeholder_engagements: {
        Row: {
          ...
          esrs_topic_id: number
          engagement_type: 'survey' | 'interview' | 'workshop' | 'focus_group' | 'public_consultation'
      ...
      evidence_documents: {
        Row: {
          ...
          document_type: 'policy' | 'certification' | 'kpi_data' | 'report' | 'other'
          file_url: string
...
export type MaterialityAssessment = Database['public']['Tables']['materiality_assessments']['Row']
export type Stakeholder = Database['public']['Tables']['stakeholders']['Row']
export type StakeholderEngagement = Database['public']['Tables']['stakeholder_engagements']['Row']
export type EvidenceDocument = Database['public']['Tables']['evidence_documents']['Row']
export type MaterialityRationale = Database['public']['Tables']['materiality_rationale']['Row']
export type AssessmentWorkflow = Database['public']['Tables']['assessment_workflows']['Row']